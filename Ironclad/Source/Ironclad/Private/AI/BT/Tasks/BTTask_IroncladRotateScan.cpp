...
float UBTTask_IroncladRotateScan::IC_NormalizeYaw(float Yaw)
{
	return FRotator::NormalizeAxis(Yaw);
}

float UBTTask_IroncladRotateScan::IC_MoveTowardAngle(float CurrentYaw, float TargetYaw, float MaxDelta)
{
